/* Correction with 5-d acceptance-THnSparse-SectorDependent, NLP (No Leading Pion (higher Zh)), good matching, and Xf cut */

#include "functions.h"

void corr5d_Sector(TString target = "Fe", TString nfold = "*", TString binning_name = "", bool cluster = false){
	...
	TString acc_path;
    if (nfold=="*") acc_path = "../Acceptance/Acc5d_Sector/Acc5dSector_A"+target+"_"+binning_name+".root";
    else acc_path = "../Acceptance/Acc5d_Sector/Acc5dSector_"+target+nfold+"_"+binning_name+".root";
    ...
    TString out_file;
    if (nfold=="*") out_file = "./Corr5d_Sector/Corr5dSector_A"+target+"_"+binning_name+".root";
    else out_file = "./Corr5d_Sector/Corr5dSector_"+target+nfold+"_"+binning_name+".root";
