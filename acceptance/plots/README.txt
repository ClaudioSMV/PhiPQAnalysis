...
AcceptanceSM_Fe1			(1)	: Acceptance SMorán's way of calculate it. Without cuts checked (no Nphe...)
AcceptanceCSMV_Fe1.pdf			(1)	: Acceptance Claudio's way of calculate it. Without cuts checked (no Nphe...)
AcceptanceSM_Fe2			(1)	: Same as 1, but with Yb, W, vyec, mc_Yb, mc_W cuts
AcceptanceCSMV_Fe2.pdf			(1)	: Same as 1, but with Yb, W, vyec, mc_Yb, mc_W cuts
