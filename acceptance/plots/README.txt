...
AcceptanceSM_finFe.pdf			(1)	: Acceptance SMorán's way of calculate it. Without cuts checked (no Nphe...)
AcceptanceCSMV_Fe.pdf			(1)	: Acceptance Claudio's way of calculate it. Without cuts checked (no Nphe...)
