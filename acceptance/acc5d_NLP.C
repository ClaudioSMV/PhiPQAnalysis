/* 5-d acceptance with THnSparse, NLP (No Leading Pion (higher Zh)) and non-detector-biased filling (good matching) */

#include "functions.h"

void acc5d_NLP(TString target = "Fe", TString nfold = "*", TString binning_name = ""){
    ...
    TString out_file;
    if (nfold=="*") out_file = "./Acc5d_NLP/Acc5dNLP_A"+target+"_"+binning_name+".root";
    else out_file = "./Acc5d_NLP/Acc5dNLP_"+target+nfold+"_"+binning_name+".root";
