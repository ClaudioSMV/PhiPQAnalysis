...
void ct_acc5d(TString target = "Fe", TString nfold = "*", TString binning_name = ""){
    ...
    TString out_file;
    if (nfold=="*") out_file = "./CT_Acc5d_A"+target+"_"+binning_name+".root";
    else out_file = "./CT_Acc5d_"+target+nfold+"_"+binning_name+".root";
